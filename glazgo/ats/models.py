...
CANDIDATE_STATUS = [
    ...
    (3, '3-й недозвон'), # после трех недозвонов
    (4, 'Резюме'), # после удачного созвона, кандидат направляет резюме
    (5, 'Стажировка'), # одобрив резюме, кандидат поступает на стажировку
    (6, 'Оформление'), # пройдя стажировку, кандидат оформляется
    (7, 'Отказ'), # заказчик на любой стадии может отказать кандидату, 3 недозвона, не пришел на стажировку и т.д.
    (8, 'Кадровый резерв'), # имеются несколько кандидатов, удовлетворяющих требованиям заказчика
]
